...
use App\Http\Requests\SportCompetitionRequest as StoreRequest;
use App\Http\Requests\SportCompetitionRequest as UpdateRequest;

class SportCompetitionCrudController extends CrudController
{
