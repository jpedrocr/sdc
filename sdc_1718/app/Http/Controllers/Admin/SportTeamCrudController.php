...
use App\Http\Requests\SportTeamRequest as StoreRequest;
use App\Http\Requests\SportTeamRequest as UpdateRequest;

class SportTeamCrudController extends CrudController
{
